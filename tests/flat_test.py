...
try:
    result = src.flat_concave.evaluate(data, range_end, src.qualities.quality_minmax, maximum_quality,
                                       alpha, eps, delta, src.qualities.min_max_intervals_bounding,
                                       src.qualities.min_max_maximum_quality, True)
