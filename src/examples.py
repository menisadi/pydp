...
def get_random_data(data_size, distribution_type):
    ...
    data_switch = {
        ...
        'point': __make_point_data(data_size), # POINT_d
        'threshold': __make_threshold_data(data_size),  # THRESH_d
    }
    # if user didn't specify the data-type return a normal distributed one
