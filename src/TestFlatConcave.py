...
class TestRecConcave(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.maximum_quality = qualities.min_max_maximum_quality(self.data, (0, self.range_end))
    ...
    def test_flat_concave_median(self):
        ...
        result = flat_concave.evaluate(self.data, self.range_end, qualities.quality_minmax,
        ...
        result_quality = qualities.quality_minmax(self.data, result)
